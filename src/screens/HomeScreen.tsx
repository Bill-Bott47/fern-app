...
const styles = StyleSheet.create({
  ...
  appName: { fontSize: 13, letterSpacing: 5, color: '#FF6B00', fontWeight: '700' },
  ...
  dayLabelActive: { color: '#FF6B00', fontWeight: '700' },
  workoutCard: {
    backgroundColor: '#0F172A', borderRadius: 20,
    borderWidth: 1, borderColor: '#1E293B',
    padding: 24, marginBottom: 32,
  },
  workoutLabel: { fontSize: 11, letterSpacing: 3, color: '#FF6B00', marginBottom: 8 },
  ...
  scheduleRowActive: { borderColor: '#FF6B00' },
